...
{
    public class QTypWeakPokVariousQuizzViewModel : MvxViewModel<QuestionAnswers>
    {
        #region Field
        ...
        private async Task<bool> UpdateUIByOrder(Answer answer)
        {
            ...
            switch (answer.Order)
            {
                ...
                case 13:
                    if (answer.IsSelected)
                    {
                        BackgroundColorAnswer13 = TypePok.InfoColor;
                ...
                case 14:
                    if (answer.IsSelected)
                    {
                        BackgroundColorAnswer14 = TypePok.InfoColor;
                ...
                case 15:
                    if (answer.IsSelected)
                    {
                        BackgroundColorAnswer15 = TypePok.InfoColor;
                ...
                case 16:
                    if (answer.IsSelected)
                    {
                        BackgroundColorAnswer16 = TypePok.InfoColor;
                ...
                case 17:
                    if (answer.IsSelected)
                    {
                        BackgroundColorAnswer17 = TypePok.InfoColor;
                ...
                case 18:
                    if (answer.IsSelected)
                    {
                        BackgroundColorAnswer18 = TypePok.InfoColor;
