...
{
    public class QTypPokStatQuizzViewModel : MvxViewModel<QuestionAnswers>
    {
        #region Field
        ...
        private async Task LoadData()
        {
            ...
            Answer answer = QuestionAnswers.Answers.Find(m => m.IsCorrect.Equals(true));

            Pokemon = await _pokemonService.GetByIdAsync(answer.IsCorrectID);
